...
Make the modeline flat. Information gleaned from [[http://www.reddit.com/r/emacs/comments/23l9oi/flat_modeline/?utm_source=dlvr.it&utm_medium=twitter][this Reddit
discussion]].
...
#+begin_src emacs-lisp
  (use-package powerline
    :config
    (progn
      ;; Emacs 24.4 on OSX Cocoa has sRGB support. If enabled, the XPMs
      ;; that are generated for the separators have the colors screwed
      ;; up. They are 'almost' the right color, but lighter. This makes
      ;; the whole thing look bad. Let's just turn them off for now...
