...
** DONE Figure out what this does:

#+begin_example
  (setq js2-mode-toggle-warnings-and-errors t)
#+end_example

This is not actually a variable, but a function that toggles the two
variables that control warnings and errors:
- =js2-mode-show-parse-errors=
- =js2-mode-show-strict-warnings=

I'm pretty sure that this line of code was grabbed from someone's
Emacs config, but it doesn't look like something that is valid. Here
of the function definition (grabbed from [[https://github.com/mooz/js2-mode/blob/master/js2-mode.el][github.com]]):
